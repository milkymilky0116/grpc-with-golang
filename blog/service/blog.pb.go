...
var file_blog_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x08, 0x52, 0x65, 0x61, 0x64, 0x42, 0x6c, 0x6f,
	0x67, 0x12, 0x0c, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x1a,
	...
	0x74, 0x75, 0x73, 0x12, 0x28, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x6c, 0x6f,
	0x67, 0x12, 0x0c, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x1a,
...
var file_blog_proto_depIdxs = []int32{
	0, // 0: blog.Blog.CreateBlog:input_type -> blog.Post
	2, // 1: blog.Blog.ReadBlog:input_type -> blog.PostId
	0, // 2: blog.Blog.UpdateBlog:input_type -> blog.Post
	2, // 3: blog.Blog.DeleteBlog:input_type -> blog.PostId
	3, // 4: blog.Blog.ListBlog:input_type -> google.protobuf.Empty
	2, // 5: blog.Blog.CreateBlog:output_type -> blog.PostId
	0, // 6: blog.Blog.ReadBlog:output_type -> blog.Post
	1, // 7: blog.Blog.UpdateBlog:output_type -> blog.Status
	1, // 8: blog.Blog.DeleteBlog:output_type -> blog.Status
	0, // 9: blog.Blog.ListBlog:output_type -> blog.Post
